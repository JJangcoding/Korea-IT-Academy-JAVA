...
### 21. Ex8_Work - 별찍기
- **파일:** `Ex8_work`
- 별찍기 문제를 통해 for문에 대한 이해를 쌓았습니다.

### 22. Ex9_2work
- **파일:** `Ex9_2work`
- 2중 for문을 사용하여 1부터 n까지의 합계를 계산

### 23. Ex1_Break
- **파일:** `Ex1_Break`
- break 문을 활용하여 반복문을 탈출하는 방법에 대해 학습

### 24. Ex2_Break
- **파일:** `Ex2_Break`
- switch 문과 break를 연동하여 사용하는 것에 대해 학습
...
### 26. Ex4_Continue
- **파일:** `Ex4_Continue`
- while문과 Continue 문을 혼합해서 사용하는 것에 대해 학습

### 27. Ex5_label
- **파일:** `Ex5_label`
- 반복문에 식별자를 지정하는 방법에 대해 학습
  
### 27. Ex6_label
- **파일:** `Ex6_label`
- Continue 문과 식별자를 혼합해서 사용하는 것에 대해 학습

## 2023년 1월 6일
### 28. Ex1_Scanner
- **파일:** `Ex1_Scanner`
- 키보드에서 값을 입력 받을 수 있게 해주는 클래스에 대해 학습

### 29. Ex2_work
- **파일:** `Ex2_work`
- Scanner 클래스를 활용하여 변수값들을 비교하는 방법에 대해 학습
...
### 31. Ex1_work
- **파일:** `Ex1_work`
- 배열에 대해 선언과 생성을 한번에 하는 방법에 대해 학습

### 32. Ex2_work
- **파일:** `Ex2_work`
- 배열을 활용하여 최대값을 구하는 방법에 대해 학습

### 33. Ex3_work
- **파일:** `Ex3_work`
- 배열을 활용하여 소수를 판단하는 방법에 대해 학습

### 34. Ex4_work
- **파일:** `Ex4_work`
- 배열을 활용하여 구구단을 구현하는 방법에 대해 학습

## 2023년 1월 9일

### 35. Ex1_Baseball
- **파일:** `Ex1_Baseball`
- 숫자 야구 게임을 구현하는 방법에 대해 학습
